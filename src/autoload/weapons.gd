...
func _ready() -> void:
	...
	_reg("elite", {"slot": 2, "price": 400, "damage": 38, "hs": 4.0, "armor": 0.475, "rpm": 750, "clip": 30, "ammo": 120, "move": 240, "spread": 0.55, "range_mod": 0.79, "pen": 1.0, "type": "pistol", "snd": "res://assets/sounds/weapons/elite-1.wav", "cycle": 0.08, "recoil": _pistol_recoil(12), "kill": 300, "display": "DUAL BERETTAS", "dual": true})
	...
	_reg("r8", {"slot": 2, "price": 800, "damage": 86, "hs": 4.0, "armor": 0.939, "rpm": 120, "clip": 8, "ammo": 8, "move": 220, "spread": 0.52, "range_mod": 0.81, "pen": 2.0, "type": "pistol", "snd": "res://assets/sounds/weapons/revolver-1.wav", "cycle": 0.4, "recoil": [Vector2(-3.2, 0.1)], "kill": 300, "display": "R8 REVOLVER", "revolver": true, "cock": 0.207, "alt_cycle": 0.166, "alt_spread": 3.2, "cock_snd": "res://assets/sounds/weapons/revolver_cock.wav"})
